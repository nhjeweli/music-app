...
const PostList = ({ posts }) => {
  ...
  return (
    <motion.div variants={fadeIn("up", 0.4)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.3 }} className="flex flex-col items-center">
      ...
      <button className="btn btn-lg bg-accent">View all posts</button>
    </motion.div>
  )
}
